...
hyperparameters = {
  "learning_rate": 0.001,
  "noise_level": 0.2,
  "input_layer_size": [32,32,1],
  "class_count": 10,
  "encoder_layer_definitions": [
    # kernel_field_size, conv_stride_size, activation, 
    # local_response_normalization, max_poolk, max_poolk_stride, group
    ([11,11,3,96], [1,4,4,1], tf.nn.relu, True, [1,3,3,1], [1,2,2,1], 1),
    ([5,5,48,256], [1,1,1,1], tf.nn.relu, True, [1,3,3,1], [1,2,2,1], 2),
    ([3,3,256,384],[1,1,1,1], tf.nn.relu, False, None, None, 1),
    ([3,3,192,384],[1,1,1,1], tf.nn.relu, False, None, None, 2),
    ([3,3,192,256],[1,1,1,1], tf.nn.relu, False, [1,3,3,1], [1,2,2,1], 2),
    # Flag, fully_connected_kernel_size, activation, 
    # local_response_normalization, _, _, dropout_keep_prob
    (None, [9216, 4096], tf.nn.relu, False, None, None, 0.5),
    (None, [4096, 4096], tf.nn.relu, False, None, None, 0.5),
    (None, [4096, 1000], tf.nn.softmax, False, None, None, 1),
  ],
